  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#07090f] text-white">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-16 sm:py-24">
        <header className="rounded-[36px] border border-white/10 bg-white/5 p-8 shadow-[0_35px_120px_rgba(15,23,42,0.55)] backdrop-blur-xl">
          <div className="flex flex-col items-center gap-6 text-center sm:fl>ex-row sm:items-center sm:text-left sm:justify-between">
            ...
            <div className="rounded-3xl border border-white/10 bg-[#11131c]/90 px-5 py-4 text-left shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
