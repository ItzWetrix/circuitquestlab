...
export default function LinkCard({ link, className = "" }: { link: LinkItem; className?: string }) {
  return (
    <a
      ...
      className={`group relative overflow-hidden rounded-4xl border border-white/10 bg-[#11131c]/95 p-6 text-left shadow-[0_8px_30px_rgba(0,0,0,0.18)] transition duration-300 hover:-translate-y-1 hover:border-[#A855F7]/35 hover:shadow-[0_10px_40px_rgba(168,85,247,0.12)] ${className}`}
    >
